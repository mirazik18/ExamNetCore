...
namespace d2tv.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginModel model)
        {
            ...
            {
                User user2 = new User { UserName = "Mikhail", Email = "cayden03@mail.ru" };
                var result = await userManager.CreateAsync(user2, "put12please");
                if (result.Succeeded)
                {
                    await userManager.AddToRoleAsync(user2, "writer");
                }
